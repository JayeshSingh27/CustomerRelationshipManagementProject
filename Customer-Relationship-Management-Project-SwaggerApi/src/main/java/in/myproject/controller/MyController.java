...
import in.myproject.service.ICustomerService;
...
public class MyController {
	...
	public String welcomePage(@RequestParam String userId, @RequestParam String password) {
		...
		else if(userId.equals("admin") && !password.equals("root123"))
		{
			return "login_failed_incorrectPassword";
		}
		else if(!userId.equals("admin") && !password.equals("root123"))
		{
			return "login_failed_incorrectUsername";
		}
		return "login_failed_incorrectUsernamePassword";
